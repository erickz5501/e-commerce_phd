							...
							<div class="login-form form-item form-stl">
								...
								<form name="frm-login" method="POST" action="{{route('login')}}">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="frm-login-uname" name="email" placeholder="Ingrese su correo electrónico" :value="old('email')" required autofocus>
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-login-pass">Contraseña:</label>
										<input type="password" id="frm-login-pass" name="password" placeholder="Ingrese su contraseña" required autocomplete="current-password">
									</fieldset>
