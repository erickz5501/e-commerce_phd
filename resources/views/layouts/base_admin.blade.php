                        ...
                        <div class="primary-nav-section">
                            <div class="container">
                                <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="{{ route('admin.categories') }}" class="link-term mercado-item-title">Categorias</a>
                                    </li>
                                    <li class="menu-item">
                                    ...
                                    <li class="menu-item">
                                        <a href="{{ route('admin.homecategories') }}" class="link-term mercado-item-title">Manage Home Categories</a>
                                    </li>
                                    <li class="menu-item">
